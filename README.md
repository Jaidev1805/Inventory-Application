...
A modern, lightweight inventory management web application built with Node.js and Express, created as part of [The Odin Project's](https://theodinproject.com) Node.js curriculum. It allows users to create, view, update, and delete product categories and inventory items, with form validation and PostgreSQL-backed persistence.
